...
(() => {
  ...
  const EN = {
    ...
    // ---- FAQ (Startseite) ----
    "— BEVOR DU FRAGST": "— BEFORE YOU ASK",
    "Häufige": "Common",
    "Fragen.": "Questions.",
    "Was kostet eine Website bei euch?": "What does a website cost with you?",
    ...
    "Ja. Auf Wunsch übernehmen wir schnelles, sicheres Hosting plus laufende Pflege — Updates, Backups und Monitoring laufen automatisch. Deine Seite bleibt erreichbar, aktuell und geschützt.": "Yes. On request we handle fast, secure hosting plus ongoing care — updates, backups and monitoring run automatically. Your site stays online, current and protected.",
    "Was braucht ihr von mir zum Start?": "What do you need from me to get started?",
    "Ein kurzes Briefing zu deinem Vorhaben — und Texte, Bilder oder Logo, falls vorhanden. Den Rest klären wir gemeinsam im Erstgespräch. Du musst nicht wissen, wie eine Website technisch funktioniert. Das ist unser Job.": "A short briefing on your project — plus texts, images or a logo if you have them. We'll sort out the rest together in the intro call. You don't need to know how a website works technically. That's our job.",
